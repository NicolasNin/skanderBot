...
class Token():
	"""this class implement multiple ways to derive a dictionnary from a list of list of token(words or charactere
	...
	"""
	def __init__(self,liste,n=2,concatenate=True,initToken=False):
		self.key_size=n
		self.listeTokens=liste 		#this is a liste of liste
		...
		self.initToken=initToken 	#say if we should add a special token to say where to begin	its no use if we concatenate then there'd be only one start
...
def testToken():
	...
	l=[[1],[2]]
	t=Token(l,n=1,concatenate=False)
	t.createDic()
	print(t.dic)
	...
	print(t.dic)
	print("n=2")
	t=Token(l,n=2,concatenate=False)			
	t.createDic()
	print(t.dic)
	print("test concatenate [1,2],[3,4],[8],[5,6,7]"	)				
	l=[[1,2],[3,4],[],[8],[5,6,7]]
	t=Token(l,n=1,concatenate=True)
	print(t.listeTokens)			
	print("no concat n=1")
	l=[[1,2],[3,4],[],[8],[5,6,7]]
	t=Token(l,n=1,concatenate=False)
	...
	l=[[1,2],[3,4],[],[8],[5,6,7]]
	t=Token(l,n=1,concatenate=False,initToken=True)
	t.createDic()
	print(t.dic)
def main():
	testToken()
